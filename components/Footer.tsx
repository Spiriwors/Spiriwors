...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      icon: Mail,
      url: "mailto:spiriwors@gmail.com",
      label: "Email",
      username: "spiriwors@gmail.com",
    },
  ];
    ...
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <img
                ...
                decoding="async"
              />
              <span className="text-2xl font-bold text-white amatic-sc-bold">
                SPIRIWORS
              </span>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold text-white mb-4 amatic-sc-bold">
              Navegación
            </h3>
