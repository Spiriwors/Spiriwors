...
export const FALLBACK_PROJECTS: Project[] = [
  {
    ...
    featured_description: 'Suyay, la princesa rana de la tribu, es raptada por unos codiciosos murciélagos. Su padre el sapo Cacique, buscará la forma de rescatar a su pequeña.Proyecto ganador del estímulo FDC',
    display_order: 1,
  ...
  },
  {
    ...
    featured_description: 'En un colegio desolado y gris, un niño (número 14 de la lista), luchará para proteger su identidad, a pesar de sus calificaciones... Tesis de grado universitario',
    display_order: 13,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
